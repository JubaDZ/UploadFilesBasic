...
if($("#DivdiffTime").length ){
	
	var LoadingTime = $("#diffTime").html();
	
	var timer2 = setInterval(function() {
	$("#diffTime").html(LoadingTime);	
    if (LoadingTime == 0) {
		
        $("#DivdiffTime").html('<code><i class="icon-spin4 animate-spin"></i> ' + Loading + ' ...</code>');
...
if($("#dowloadDiv").length ){
	...
	if(IsDirect && IsPlayMedia)
	{
	 
	 var MediaSource = $("#MediaSource").html();
	 $("#MediaSource").html('');
	 
	 var mediaHtml   = $("#media").html();	
	 $("#media").html('');
