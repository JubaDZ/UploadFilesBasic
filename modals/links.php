...
<table class="table table-striped links">
	...
	<?php } ?>
      ...
      <tr>
        <td class="col-md-2 hidden-sml singleline" id="label_url"> <?php echo $lang[18] ?>:</td>
        <td class="col-md-10"> 
		  <div class="input-group" style="margin: 0px;">
                <input type="text" data-toggle="tooltip" data-placement="top" title="<?php echo $lang[18] ?>" class="form-control" id="url" style="text-align: left;direction: ltr;" readonly>
			    <span class="input-group-btn">
